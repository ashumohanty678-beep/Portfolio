...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 sm:gap-2 bg-white/80 dark:bg-black/70 border border-neutral-200 dark:border-white/15 backdrop-blur-xl py-1 px-1.5 rounded-full shadow-2xl">
        {items.map((item) => {
