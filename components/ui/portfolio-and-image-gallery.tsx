...
export interface RadialScrollGalleryProps
  ...
  disabled?: boolean;
  /** Whether to pin the element to the viewport during scroll. Defaults to false to prevent empty pin spacers. */
  pin?: boolean;
}
...
>(
  (
        ...
        if (!prefersReducedMotion) {
          ...
          gsap.to(containerRef.current, {
            ...
            scrollTrigger: {
              trigger: pinRef.current,
              pin: pin,
              start: pin ? startTrigger : 'top 85%',
              end: pin ? `+=${scrollDuration}` : 'bottom 15%',
              scrub: 1,
    ...
    const visibleAreaHeight = childSize
      ...
      : circleDiameter * visibleDecimal + 150;
